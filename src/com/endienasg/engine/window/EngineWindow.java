package com.endienasg.engine.window;

import com.endienasg.engine.Mouse;
...
public class EngineWindow {
    ...
    public void create(){
        ...
        GLFW.glfwSetWindowPos(this.id,
                (this.vidMode.width() - this.bufferedWidth.get(0))/2,
                (this.vidMode.height() - this.bufferedHeight.get(0))/2);


        GLFW.glfwMakeContextCurrent(this.id);
        GL.createCapabilities();
        GL11.glViewport(0,0,this.bufferedWidth.get(0),bufferedHeight.get(0));
